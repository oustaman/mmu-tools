...
const WEEKS = [
{
 ...
 workshop:{
  ...
  run:[
   ...
   {t:"0:45", w:"45m", s:"Mark the example portfolio", d:"Open <a href=\"example.html\">the example portfolio</a> \u2014 a complete, finished-looking submission we wrote. Same groups. A mark out of 100 against each of the four criteria, and <b>one sentence of evidence for every number</b>. No mark without a reason. Circulate and ask one question only: where in the document is that?"},
